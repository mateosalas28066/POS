...
| NUBE2·OlaB | Inventario multi-bodega (`ubicaciones` compartidas, movimientos entrada/salida/ajuste/traslado+confirmación/conversión) con sync delta append-only por cursor. Requiere migración 006 (nube) + 013 (POS) aplicadas también a la **BD real** (ver Despliegue abajo) | 📋 planificado |

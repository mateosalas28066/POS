...
class RepositorioMovimientosUbicacion(Protocol):
    """Inventario multi-ubicación: append-only salvo el flip pendiente->confirmado."""
...
class RepositorioOutbox(Protocol):
    # "EventoSync" vive en sync_pdv.outbox; el puerto es estructural y las
    # anotaciones son lazy (PEP 563), así que core no importa sync_pdv.
